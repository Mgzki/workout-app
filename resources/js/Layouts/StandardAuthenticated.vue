<template>
    <section class="px-3 py-4 md:px-6 md:py-8">
        <nav class="md:flex md:justify-between md:items-center">
            ...
            <!-- Hamburger -->
            <div class="-mr-2 flex items-center md:hidden top-0 right-1 fixed mt-1 mr-2">
                <button @click="showingNavigationDropdown = ! showingNavigationDropdown" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-blue-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
